                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-3 {{ $errors->has('issue_date') ? 'has-error' :'' }}">
                                            {{ Form::label('issue_date', 'Item Issue Date') }}
                                        ...
                                        <div class="row">
                                            ...
                                            @foreach($components as $component)
                                                <div class="form-group form-inline col-md-12 {{ $errors->has($component->id) ? 'has-error' :'' }}">
                                                    <label for="{{ $component->id}}">
                                                        {{ $component->allergen }} <span class="text-danger"> (CAS: {{  $component->cas }})</span>
                                                    </label>
                                                    {{ Form::text($component->id,"0.001",['class'=>'form-control','required']) }}
